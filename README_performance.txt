...
In on a large sample (fils R1 R2 R3) containing 96M PE seq (R1.gz of roughly 7.2GB) took 9 minutes to read and dereplicate, and took 14 minutes in addition to gzip and write.
...
Update October 2022: Instead of siple overwrite, the best (highest SUM qualityscore) is kept of the duplicated sequence set and written to disk.
